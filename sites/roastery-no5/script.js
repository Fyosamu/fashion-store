/* ==========================================================
   Roastery No.5 — front-end script (bag, nav, forms)
   ========================================================== */
...
if (checkoutBtn) {
  checkoutBtn.addEventListener("click", () => {
    ...
    const body =
      `Hello Roastery No.5,%0D%0A%0D%0AI would like to order:%0D%0A${lines}%0D%0A%0D%0ASubtotal: $${total}` +
      `%0D%0A%0D%0AName:%0D%0AAddress:%0D%0ACountry:%0D%0APhone:%0D%0A%0D%0AThank you!`;
    window.location.href = `mailto:${CONFIG.supportEmail}?subject=${encodeURIComponent("Order — Roastery No.5")}&body=${body}`;
  });
}
...
(function categoryFilter() {
  ...
  function apply(next, push) {
    ...
    document.title = m.title + " — Roastery No.5";
