/* ==========================================================
   Ink & Quill — front-end script (bag, nav, forms)
   ========================================================== */
...
if (checkoutBtn) {
  checkoutBtn.addEventListener("click", () => {
    ...
    const body =
      `Hello Ink & Quill,%0D%0A%0D%0AI would like to order:%0D%0A${lines}%0D%0A%0D%0ASubtotal: $${total}` +
      `%0D%0A%0D%0AName:%0D%0AAddress:%0D%0ACountry:%0D%0APhone:%0D%0A%0D%0AThank you!`;
    window.location.href = `mailto:${CONFIG.supportEmail}?subject=${encodeURIComponent("Order — Ink & Quill")}&body=${body}`;
  });
}
...
(function categoryFilter() {
  ...
  function apply(next, push) {
    ...
    document.title = m.title + " — Ink & Quill";
