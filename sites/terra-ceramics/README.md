# Terra Ceramics - Handmade tableware store template

Pottery studio: wheel-thrown story, kiln facts, open-studio visits.

The complete Terra Ceramics store: one HTML page, one stylesheet, one script and 6 photographs.
